...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "EPI Control — Gestão de EPIs" },
      { name: "description", content: "Sistema interno para controle de estoque, entrega e devolução de EPIs." },
      { name: "author", content: "EPI Control" },
      { property: "og:title", content: "EPI Control — Gestão de EPIs" },
